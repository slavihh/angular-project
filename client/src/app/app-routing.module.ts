...
const routes: Routes = [
  ...
  {path: 'admin/user/subjects/:email/create', component: CreateUserSubjectComponent, canActivate: [RoleGuard], 
  ...
  {path: 'admin/user/marks/:email', component: AdminUserMarksComponent, canActivate: [RoleGuard], 
